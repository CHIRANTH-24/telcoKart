...
{/* Login Dropdown */}
<div className="relative z-50"> {/* Added z-50 for positioning above other elements */}
  <Button
    variant="ghost"
  ...
  >
    ...
    </svg> {/* Added arrow icon */}
  </Button>

  {/* Dropdown Menu */}
  {dropdownOpen && (
    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg z-50"> {/* Ensured it's over all elements */}
      <ul>
        <li>
          <Button
            variant="link"
